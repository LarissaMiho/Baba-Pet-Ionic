...
/* harmony import */ var _db_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./db.service */ "ajt+");
/* harmony import */ var _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../enum/db.enum */ "vhIe");
...
let PedidoService = class PedidoService {
    ...
    insert(pedido) {
        this.dbService.insert(pedido, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].PEDIDO);
    }
    update(pedido, key) {
        this.dbService.update(pedido, key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].PEDIDO);
    }
    getAll() {
        return this.dbService.getAll(_enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].PEDIDO);
    }
    getByKey(key) {
        return this.dbService.getByKey(key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].PEDIDO);
    }
    delete(key) {
        this.dbService.delete(key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].PEDIDO);
    }
};
...
let DbService = class DbService {
    ...
    insert(obj, dbName) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let result = yield this.db.list(dbName.toString()).push(obj);
            return result.key;
        });
    }
    update(obj, key, dbName) {
...
let UsuarioService = class UsuarioService {
    ...
    insert(usuario) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let result = yield this.dbService.insert(usuario, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].USUARIO);
            return result;
        });
    }
    update(usuario, key) {
        this.dbService.update(usuario, key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].USUARIO);
    }
    getAll() {
        return this.dbService.getAll(_enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].USUARIO);
    }
    getByKey(key) {
        return this.dbService.getByKey(key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].USUARIO);
    }
    delete(key) {
        this.dbService.delete(key, _enum_db_enum__WEBPACK_IMPORTED_MODULE_3__["DB"].USUARIO);
    }
};
